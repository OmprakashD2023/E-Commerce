...
<footer id="footer" class="section-p1">
    <div class="col">
        <img class="logo" width="140px" height="40px" src="./20220703_230159.png" alt="Logo">
        <h4>Contact</h4>
    ...
    <div class="end">
        <p>Copyright &copy; 2022 CEG CSE Students And Designed by <a href="https://ceg.annauniv.edu">CEG Students</a></p>
    </div>
</footer>
