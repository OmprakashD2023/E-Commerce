...
<section id="contact-details" class="section-p1">
    <div class="details">
        ...
        <div>
            ...
            <li>
                <a href="mailto: omprakashmff123@gmail.com" target="_blank"><i class="fa fa-envelope"></i></a>
                <p><a href="mailto: omprakashmff123@gmail.com" target="_blank">Email Will Be Updated Later</a></p>
            </li>
            <li>
...
<section id="form-details">
    ...
    <div class="people">
        <div>
            <img src="./Images/20211113_161513.jpg" style="border-radius: 50%;" alt="people1">
            <p><span>Mohan Maran</span> Frontend Developer <br> Contact: +91 9003630973<br>
                Email:mohanmaran@gmail.com
            </p>
        </div>
        <div>
            <img src="./Images/WhatsApp Image 2022-06-27 at 12.02.35 PM.jpeg" style="border-radius: 50%;" alt="people1">
            <p><span>Omprakash </span> Backend Developer <br> Contact: +91 9003630973<br>
                Email:omprakash@gmail.com
            </p>
        </div>
        <div>
            <img src="./Images/IMG_20220627_115813.jpg" style="border-radius: 50%;" alt="people1">
            <p><span>Madhubalan</span> Frontend Developer <br> Contact: +91 9003630973<br>
                Email:madhubalan@gmail.com
            </p>
        </div>
    </div>
</section>
